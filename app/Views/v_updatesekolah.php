                ...
                <div class="card-body">
                    <form action="/form/prosesupdate/<?= $data['slug']; ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?= ($validation->hasError('nama_sekolah')) ? 'is-invalid' : ''; ?>" name="nama_sekolah" value="<?= $data['nama_sekolah']; ?>" autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?= ($validation->hasError('kepala_sekolah')) ? 'is-invalid' : ''; ?>" name="kepala_sekolah" value="<?= $data['kepala_sekolah']; ?>">
                            <div class="invalid-feedback">
